<div id=body >
		...
		if (isset($typeinst))
		{
			...
			echo "
				<p>\n
					<a href='".site_url()."/modification'>Retour</a>\n
				</p>\n";
		?>
			<table>
		...
		<?php
			if($inst->IdInstParent)
			{
				echo "<td style='none'>
				<img style=\"float: left; padding-right: 20px;\" title=\"change input\" src=\"".base_url()."application/views/images/close.png\" alt=\"close content\" width=\"12\" height=\"12\" />
				<a id=\"$inst->IdInstParent\" class=\"remove\" href=\"".site_url()."/detailresultat/inst/$inst->IdInstParent\" target=\"blank\"> $inst->NameInstParent </a>
				";
			}
		?>
						</td>
